 ...
 * along with methods for peeking at the first item,
 ...
 * that uses a non-static nested clas.
...
public class Queue<Item> implements Iterable<Item> {
    ...
    /**
     * Removes and returns the item on this queue that least recently added.
     *
