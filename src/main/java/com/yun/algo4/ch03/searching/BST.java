...
/**
 * The {@code BST} class represents an ordered symbol table of generic key-value parts.
 * It supports the usual put, get, contains delete, size and is-empty method.
 ...
 *
 * It requires that they key type implements the {@code Comparable} interface and calls the
 ...
 * The put, contains, remove, minimum, maximum, ceiling, floor, select and rank operations
 * each take (n) time in the worst case, where n is the number of key-value pairs.
 * The size and is-empty operations take (1) time.
 * The keys method takes (n) time in the worst case.
 * Construction takes (1) time.
 *
 * For alternative implementations of the symbol table API, see {@link },
 * {@link BinarySearchST}, {@link SequentialSearchST}, {@link },
 *
 *
...
public class BST<Key extends Comparable<Key>, Value> {
    ...
    /**
     * Initializes an emtpy symbol table
     */
    public BST() { }
     ...
     *
     * @param key the key
     * @return {@code true} if this symbol contains {@code key} and {@code false} otherwise
     ...
     * This key has the property that there are {@code rank} keys in the symbol table
     * that are smaller. In other words, this key is the ({@code rank}+1)st smallest key
     * in the small table.
     *
