 ...
 * It also provides a keys method for interating over all of the keys.
 ...
 * The get and contains operations take (n) time in the worst case.
...
public class SequentialSearchST<Key, Value> {
     ...
     * with the new value if the symbol talbe already contains the specified key.
     * Deletes the specified key (and its associated value) from this symbol table
     * if the specified value i s {@code null}
     *
     * @param key the key
     * @param val the value
     * @throws IllegalArgumentException if {@code key} is {@code null}
    ...
    /**
     * Unit test {@code SequentialSearchST} data type.
     *
